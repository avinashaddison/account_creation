...
const platforms: Platform[] = [
  ...
  },
  {
    id: "outlook",
    name: "Outlook Login",
    description: "Automated Outlook login via Addison Proxy with FunCaptcha solving",
    href: "/admin/outlook-login",
    accentColor: "#7dd3fc",
    accentGlow: "rgba(125,211,252,0.18)",
    gradientFrom: "rgba(56,189,248,0.12)",
    gradientTo: "rgba(15,23,42,0.1)",
    badge: "ACTIVE",
    badgeActive: true,
    stats: [{ label: "Auto Login", icon: Shield }, { label: "Captcha", icon: Zap }, { label: "Proxy", icon: Globe }],
  },
  {
    id: "zenrows",
    name: "Proxy Register",
