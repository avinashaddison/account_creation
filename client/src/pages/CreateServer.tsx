...
const platforms: Platform[] = [
  ...
  {
    id: "chatgpt",
    name: "Create ChatGPT Account",
    description: "Auto-create ChatGPT accounts via Outlook email OTP verification",
    href: "/admin/chatgpt-create",
    accentColor: "#10a37f",
    accentGlow: "rgba(16,163,127,0.22)",
    gradientFrom: "rgba(16,163,127,0.12)",
    gradientTo: "rgba(5,80,60,0.04)",
    badge: "ACTIVE",
    badgeActive: true,
    stats: [{ label: "Auto Create", icon: Shield }, { label: "OTP Verify", icon: Mail }, { label: "Stealth Browser", icon: Zap }],
  },
  {
    id: "card-generator",
    name: "Card Generator",
...
function PlatformIcon({ id, accentColor, hovered }: { id: string; accentColor: string; hovered: boolean }) {
  ...
  if (id === "chatgpt") return (
    <div className={`${base} bg-[#10a37f]`} style={{ boxShadow: glow }}>
