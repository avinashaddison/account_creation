...
export default function TMCreate() {
  ...
  const [proxyUrl, setProxyUrl] = useState("wss://brd-customer-hl_86b34e68-zone-proxy:wjlhprnj2hl8@brd.superproxy.io:9222");
    ...
    <div className="space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-zinc-500 text-sm mt-0.5">Automated Ticketmaster registration with email verification</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="rounded-xl bg-[#111118] border border-white/5 p-5">
            ...
            <div className="space-y-5">
              ...
              {error && (
                <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/20 text-sm text-red-400" data-testid="text-tm-batch-error">
                  {error}
                </div>
              )}

              <Button
                className="w-full h-11 text-sm font-semibold bg-gradient-to-r from-sky-600 to-blue-600 hover:from-sky-700 hover:to-blue-700 shadow-lg shadow-sky-500/20 border-0"
              ...
              >
                {isRunning ? (
                  ...
                  <>
                    ...
                    Create {count} TM Account{count > 1 ? "s" : ""}
                  </>
                )}
              </Button>
            </div>
              ...
              <div className="flex flex-wrap gap-1.5 mb-4">
                {accounts.map((acc) => (
                  <div
                    ...
                    data-testid={`badge-tm-batch-account-${acc.id}`}
                  >
                    {acc.status === "verified" ? (
