      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-emerald-400/30 font-mono mt-0.5 tracking-wide">AUTOMATED MICROSOFT ACCOUNT CREATION</p>
          </div>
        </div>
        {isRunning && (
        ...
        <div className="space-y-4">
          <div className="rounded-xl p-5 space-y-4" style={{ background: 'linear-gradient(135deg, rgba(15,21,32,0.8) 0%, rgba(13,17,23,0.9) 100%)', border: '1px solid rgba(0,255,65,0.08)' }}>
            <div className="flex items-center gap-2 mb-1">
              <Mail className="w-3.5 h-3.5 text-emerald-400/50" />
              <span className="text-[10px] font-mono text-emerald-400/40 uppercase tracking-wider">Account Settings</span>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                disabled={isRunning}
                className="h-9 bg-black/30 border-emerald-500/10 text-emerald-50 font-mono text-sm rounded-lg w-32"
