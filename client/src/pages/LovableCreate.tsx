...
import { Heart, Play, Hash, Layers, ChevronRight, Radio, AtSign, Zap } from "lucide-react";
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-[11px] font-mono mt-0.5 pl-8" style={{ color: PA(0.28) }}>
            Automate Lovable.dev account creation — temp emails via mail.gw API
          </p>
        </div>
        <div className="flex items-center gap-2.5 text-[10px] font-mono">
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg" style={{ background: "rgba(74,222,128,0.06)", border: "1px solid rgba(74,222,128,0.18)" }}>
            ...
            <span style={{ color: "rgba(74,222,128,0.35)" }}>created</span>
          </div>
          {pendingCount > 0 && (
