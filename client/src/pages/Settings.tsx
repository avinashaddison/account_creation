...
const apiKeyFields: ApiKeyField[] = [
  ...
  {
    id: "presale-proxy",
    label: "Presale Proxy (ZenRows WSS)",
    description: "ZenRows WebSocket browser URL used exclusively for Shakira presale signup (wss://...). Separate session from TM account creation.",
    icon: <Globe className="w-4 h-4" />,
    getEndpoint: "/api/settings/presale-proxy",
    putEndpoint: "/api/admin/presale-proxy",
    fieldName: "url",
  ...
  {
    id: "nopecha",
    label: "NopeCHA API Key 1",
    description: "Primary hCaptcha solver — nopecha.com ($1 per 90,000 solves). Auto-switches to Key 2 when this key hits its daily limit.",
    icon: <Shield className="w-4 h-4" />,
  ...
  {
    id: "nopecha2",
    label: "NopeCHA API Key 2",
    description: "Fallback NopeCHA key — automatically used when Key 1 hits its daily/credit limit, doubling your effective solve capacity.",
    icon: <Shield className="w-4 h-4" />,
    getEndpoint: "/api/settings/nopecha-api-key-2",
    putEndpoint: "/api/admin/nopecha-api-key-2",
    fieldName: "key",
