...
const apiKeyFields: ApiKeyField[] = [
  ...
  {
    id: "tm-account-proxy",
    label: "TM Account Proxy (SOAX)",
    description: "Residential HTTP proxy for Ticketmaster account creation (http://user:pass@host:port). Uses SOAX rotating sessions.",
    icon: <Globe className="w-4 h-4" />,
    getEndpoint: "/api/settings/tm-account-proxy",
    putEndpoint: "/api/admin/browser-proxy",
    fieldName: "url",
    placeholder: "http://user:pass@proxy.soax.com:5000",
