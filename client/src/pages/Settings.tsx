...
const apiKeyFields: ApiKeyField[] = [
  ...
  },
  {
    ...
    description: "Primary hCaptcha solver for Stripe 3DS (anti-captcha.com — recommended over 2captcha for hCaptcha)",
    icon: <Shield className="w-4 h-4" />,
  ...
  },
  {
    ...
    description: "Fallback CAPTCHA solver (used if anti-captcha.com is not configured or fails)",
    icon: <Shield className="w-4 h-4" />,
