    ...
    <div className="min-h-screen flex" style={{ background: '#0d1117' }}>
      <aside className="w-[260px] flex flex-col shrink-0 h-screen sticky top-0 border-r border-cyan-500/[0.12]" style={{ background: 'linear-gradient(180deg, #0f1520 0%, #0d1117 100%)' }} data-testid="sidebar">
        ...
        <nav className="flex-1 px-3 space-y-0.5 overflow-y-auto">
          {nav.map((item) => {
            const isActive = location === item.href || (item.href === "/admin/create-server" && (location === "/admin/la28-create" || location === "/admin/tm-create" || location === "/admin/uefa-create" || location === "/admin/brunomars-create" || location === "/admin/outlook-login" || location === "/admin/zenrows-register"));
            return (
